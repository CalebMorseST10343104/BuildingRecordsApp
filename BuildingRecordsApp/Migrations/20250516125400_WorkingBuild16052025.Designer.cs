...
namespace BuildingRecordsApp.Migrations
{
    ...
    [Migration("20250516125400_WorkingBuild16052025")]
    partial class WorkingBuild16052025
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BuildingRecordsApp.Models.Unit", b =>
                {
                    ...
                    b.HasOne("BuildingRecordsApp.Models.Lease", "Lease")
                        .WithOne("Unit")
                        .HasForeignKey("BuildingRecordsApp.Models.Unit", "LeaseId");

                    b.HasOne("BuildingRecordsApp.Models.Ownership", "Ownership")
                        .WithOne("Unit")
                        .HasForeignKey("BuildingRecordsApp.Models.Unit", "OwnershipId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
